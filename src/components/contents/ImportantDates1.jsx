...
const ImportantDates1 = () => {
  const dates = [
    { event: 'Paper Submission Opening', date: '20 Mar 2025', remarks: '' },
    { event: 'Paper Submission Closing', date: '20 Aug 2025', remarks: '' },
    { event: 'Notification Starts', date: '20 days from date of submission', remarks: '' },
    { event: 'Registration Closing', date: '15 Oct 2025', remarks: '' },
    { event: 'Final Paper Submission', date: '25 Oct 2025', remarks: '' },
    { event: 'Copyright Submission', date: 'Starts from 20 Oct 2025', remarks: '' },
    { event: 'Conference Dates', date: '20-21 Dec 2025', remarks: '' }
  ];
